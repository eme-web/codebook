        ...
        <section>
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="max-w-xl my-3">
              ...
              <p className="my-3">
                <button  className="inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 " disabled="">Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button> 
                 <button  className="inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 "  disabled="">Remove Item <i className="ml-1 bi bi-trash3"></i></button>   
              </p>
